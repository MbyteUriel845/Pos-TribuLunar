...
public class ReceiptBuildingHelper {
	...
	public static final String RECEIPT_HEADER = String.format("          Tribu Lunar Meets %n Geminis %n       www.tribulunar.com   %n     info@tribulunar.com");
	public static final String RECEIPT_FOOTER = String.format("   www.tribulunar.com");
	public static final String SPACER = " ";
	public static final String NEW_LINE = System.getProperty("line.separator");
	public static final String TOTAL = "TOTAL";
	public static final String PAYMENT = "Pagado";
	public static final String CHANGE = "Cambio";
	public static final String IVA = "IVA Incluido";
