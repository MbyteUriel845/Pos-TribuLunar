...
public class PosUiConstants {
	...
	public static final String POS_TITLE = "POS TRIBU LUNAR";
	//public static final String LABEL_CUSTOM_PRICE = "Custom price";
	public static final String LABEL_CUSTOM_PRICE = "Precio";
	//public static final String LABEL_CUSTOM_PRICE_EXAMPLE = "(units*price + ENTER. Example: 2.4 | 2*.75 | 3*1.2 ):";
	public static final String LABEL_HISTORY = "Historial de ventas";
	public static final String LABEL_TOTAL = "Total:";
	public static final String LABEL_PRICE_FORMAT = "%.2f";
	public static final String LABEL_DEFAULT_TOTAL_VALUE = "0.00";
	public static final String LABEL_PAYMENT = "Pago:";
	public static final String LABEL_CHANGE = "Cambio:";
	public static final String COLUMN_PRODUCT = "Productos";
	public static final String COLUMN_QUANTITY = "Cantidad";
	public static final String COLUMN_PRICE = "Precio";
	public static final String BUTTON_CHECKOUT_ONLY = "Finalizar orden";
	public static final String BUTTON_CHECKOUT_PRINT = "Imprimir orden";
	public static final String BUTTON_CANCEL_SALE = "Cancelar venta";
	public static final String BUTTON_EXIT = "Salir";
	public static final String BUTTON_DELETE_ITEM_LINE = "Eliminar un producto";
	public static final String BUTTON_DELETE_ALL_ITEM_LINE = "Eliminar todo";
